  ...
  addHtml(`<div class="proj-card">
    ...
    <div class="proj-card-body">
      ...
      <div class="proj-info">
        ...
        <div class="proj-tags" style="margin-top:8px">${p.tags.map(t=>`<span style="color:var(--mgs-border);font-size:10px">#${t} </span>`).join('')}</div>
